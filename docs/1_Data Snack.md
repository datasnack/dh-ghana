...
{% icon "home-fill" size=16 %} [https://datasnack.org/](https://datasnack.org/)  
{% icon "feed-tag" size=16 %} [https://datasnack.org/our-work.html](https://datasnack.org/our-work.html)  
{% icon "mark-github" size=16 %} [https://github.com/datasnack/](https://github.com/datasnack/)  
{% icon "note" size=16 %} [https://zenodo.org/communities/datasnack/records](https://zenodo.org/communities/datasnack/records)  
{% icon "organization" size=16 %} [Bernhard Nocht Institute for Tropical Medicine](https://www.bnitm.de/en/), Hamburg, Germany

**Data Snack** is primarily funded and empowered by the "Innovate! Academy" at the [Joachim Herz Foundation](https://www.joachim-herz-stiftung.de/en/research/research-and-application/innovation-academy) and receives additional funds from the German Federal Ministry of Research, Technology and Space (BMFTR). 
